...
const urlEndpoint = "https://ik.imagekit.io/amirbencc";
    ...
    <section className="product_section layout_padding">
      <div className="container">
        <div className="heading_container">
          ...
          <p>
            Embark on a delectable journey at Yumm! Bakery, where each
            confection is a symphony of flavors that dance on your taste buds.
          </p>
        </div>
